...
// $sql = "CREATE TABLE `jiet`.`admin` (`id` INT(10) NOT NULL AUTO_INCREMENT , `mobile` INT(10) NOT NULL , `email` VARCHAR(25) NOT NULL , `password` VARCHAR(20) NOT NULL , PRIMARY KEY (`id`), UNIQUE (`mobile`)) ENGINE = InnoDB";
// $sql = "ALTER TABLE `admin` ADD `name` VARCHAR(20) NOT NULL AFTER `id`";
