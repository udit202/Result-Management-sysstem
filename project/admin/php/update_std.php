...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    if(isset($_POST['up_rollno'])){
        ...
        $sql ="UPDATE `student` SET `name` = '$username', `father` = '$father', `class` = '$class', `eng` = '$eng', `hindi` = '$Hindi', `math` = '$math', `phy` = '$phy', `chem` = '$chem', `maxeng` = '$maxeng', `maxhindi` = '$Hindi', `maxmath` = '$maxmath', `maxphy` = '$maxphy', `maxchem` = '$maxchem', `editby` = '$editby' WHERE `student`.`rollno` = '$std_id'"; 
